    ...
    pub mod store_sequence {
        ...
        pub mod request {
            ...
            pub struct TYPE {
                #[serde(
                    rename = "@type",
                    default = "crate::sdv_v2::airbag_seat_massager::store_sequence::request::id"
                )]
                pub model_id: String,
        ...
        pub mod response {
            ...
            pub struct TYPE {
                #[serde(
                    rename = "@type",
                    default = "crate::sdv_v2::airbag_seat_massager::store_sequence::response::id"
                )]
                pub model_id: String,
...
pub mod camera {
    ...
    pub mod feed {
        ...
        pub struct TYPE {
            #[serde(rename = "@type")]
            #[derivative(Default(value = "crate::sdv_v2::camera::feed::id()"))]
            pub model_id: String,
    ...
    pub mod show_notification {
        ...
        pub mod request {
            ...
            pub struct TYPE {
                #[serde(rename = "@type")]
                #[derivative(Default(
                    value = "crate::sdv_v2::hmi::show_notification::request::id()"
                ))]
                pub model_id: String,
        ...
        pub mod response {
            ...
            pub struct TYPE {
                #[serde(rename = "@type")]
                #[derivative(Default(
                    value = "crate::sdv_v2::hmi::show_notification::response::id()"
                ))]
                pub model_id: String,
...
pub mod seat_massager {
    ...
    pub mod sequence_names {
        ...
        pub struct TYPE {
            #[serde(rename = "@type")]
            #[derivative(Default(value = "crate::sdv_v2::seat_massager::sequence_names::id()"))]
            pub model_id: String,
    ...
    pub mod load_sequence {
        ...
        pub mod request {
            ...
            pub struct TYPE {
                #[serde(rename = "@type")]
                #[derivative(Default(
                    value = "crate::sdv_v2::seat_massager::load_sequence::request::id()"
                ))]
                pub model_id: String,
                pub sequence_name: String,
            }
        ...
        pub mod response {
            ...
            pub struct TYPE {
                #[serde(rename = "@type")]
                #[derivative(Default(
                    value = "crate::sdv_v2::seat_massager::load_sequence::response::id()"
                ))]
                pub model_id: String,
    ...
    pub mod pause {
        ...
        pub mod request {
            ...
            pub struct TYPE {
                #[serde(rename = "@type")]
                #[derivative(Default(
                    value = "crate::sdv_v2::seat_massager::pause::request::id()"
                ))]
                pub model_id: String,
            }
        }
        pub mod response {
            ...
            pub struct TYPE {
                #[serde(rename = "@type")]
                #[derivative(Default(
                    value = "crate::sdv_v2::seat_massager::pause::response::id()"
                ))]
                pub model_id: String,
                pub status: crate::sdv_v2::seat_massager::status::TYPE,
            }
    ...
    pub mod play {
        ...
        pub mod request {
            ...
            pub struct TYPE {
                #[serde(rename = "@type")]
                #[derivative(Default(
                    value = "crate::sdv_v2::seat_massager::play::request::id()"
                ))]
                pub model_id: String,
            }
        }
        pub mod response {
            ...
            pub struct TYPE {
                #[serde(rename = "@type")]
                #[derivative(Default(
                    value = "crate::sdv_v2::seat_massager::play::response::id()"
                ))]
                pub model_id: String,
                pub status: crate::sdv_v2::seat_massager::status::TYPE,
            }
    ...
    pub mod reset {
        ...
        pub mod request {
            ...
            pub struct TYPE {
                #[serde(rename = "@type")]
                #[derivative(Default(
                    value = "crate::sdv_v2::seat_massager::reset::request::id()"
                ))]
                pub model_id: String,
            }
        }
        pub mod response {
            ...
            pub struct TYPE {
                #[serde(rename = "@type")]
                #[derivative(Default(
                    value = "crate::sdv_v2::seat_massager::reset::response::id()"
                ))]
                pub model_id: String,
                pub status: crate::sdv_v2::seat_massager::status::TYPE,
            }
...
pub mod vehicle {
    ...
    pub mod vehicle_identification {
        ...
        pub struct TYPE {
            #[serde(rename = "@type")]
            #[derivative(Default(value = "crate::sdv_v2::vehicle::vehicle_identification::id()"))]
            pub model_id: String,
